...
const Footer = () =>{
    return(
        <div className="footer-container">
            ...
            <svg height="100%" width="100%" id="svg" viewBox="0 0 1440 700" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150"><path d="M 0,700 C 0,700 0,350 0,350 C 66.20256410256411,400.7153846153846 132.40512820512822,451.4307692307692 202,408 C 271.5948717948718,364.5692307692308 344.5820512820512,226.99230769230772 436,238 C 527.4179487179488,249.00769230769228 637.2666666666668,408.6 733,427 C 828.7333333333332,445.4 910.3512820512819,322.60769230769233 992,281 C 1073.648717948718,239.39230769230767 1155.3282051282054,278.96923076923076 1230,304 C 1304.6717948717946,329.03076923076924 1372.3358974358973,339.5153846153846 1440,350 C 1440,350 1440,700 1440,700 Z" stroke="none" stroke-width="0" fill="#ff6a3dff" class="transition-all duration-300 ease-in-out delay-150"></path></svg>
